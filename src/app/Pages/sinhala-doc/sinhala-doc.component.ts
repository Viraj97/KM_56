...
@Component({
  selector: 'app-sinhala-doc',
  templateUrl: './sinhala-doc.component.html',
  styleUrls: ['./sinhala-doc.component.css']
})
export class SinhalaDocComponent {
  ...
  showmodel() {
    ...
    new SweetAlert('center','success','Customer '+this.model.NIC+' Saved');
  }
